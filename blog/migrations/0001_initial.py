# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2019-02-11 16:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.FileField(default='avatars/default.png', upload_to='avatars/', verbose_name='頭像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('up_count', models.IntegerField(default=0, verbose_name='點讚數')),
                ('down_count', models.IntegerField(default=0, verbose_name='踩數')),
                ('view_count', models.IntegerField(default=0, verbose_name='觀看數')),
            ],
            options={
                'verbose_name': '文章',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theme', models.CharField(blank=True, max_length=32, null=True)),
            ],
            options={
                'verbose_name': 'blog站點',
                'verbose_name_plural': 'blog站點',
            },
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.Article')),
                ('friend_comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='friend', to='blog.Comment')),
